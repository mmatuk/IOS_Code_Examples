...
class GenericViewController: UIViewController {
    ...
    @IBOutlet var squareVol: UILabel!
    @IBOutlet var circleVol: UILabel!
    @IBOutlet var triangleVol: UILabel!
    
    @IBAction func CalculateVol(sender: AnyObject?)
    {
        ...
        let r = (parentViewController as! CountingTabBarController).r
        let b = (parentViewController as! CountingTabBarController).b
        let h = (parentViewController as! CountingTabBarController).h
        
        squareAreaTotal = (a*a*a)
        circleAreaTotal = (4 * M_PI * (r*r*r))/3
        triangleAreaTotal = (M_PI * b * h)/3
        
        if (squareVol != nil)
        {
            squareVol.text = String(format: "%.2f",squareAreaTotal)
        }
        if (circleVol != nil)
        {
            circleVol.text = String(format: "%.2f",circleAreaTotal)
        }
        if (triangleVol != nil)
        {
            triangleVol.text = String(format: "%.2f",triangleAreaTotal)
        }
    }
    ...
    @IBAction func calculateArea(sender: AnyObject?) {
        ...
        if (squareArea != nil)
        {
            squareArea.text = String(format: "%.2f",squareAreaTotal)
        }
        
        if (circleArea != nil)
        {
            circleArea.text = String(format: "%.2f",circleAreaTotal)
        }
        
        if (triangleArea != nil)
        {
            triangleArea.text = String(format: "%.2f",triangleAreaTotal)
        }
    ...
    */
    ...
    override func viewDidLoad() {
        ...
        squareInput.text = "\((parentViewController as! CountingTabBarController).a)"
        circleInput.text = "\((parentViewController as! CountingTabBarController).r)"
        triangleInputB.text = "\((parentViewController as! CountingTabBarController).b)"
        triangleInputH.text = "\((parentViewController as! CountingTabBarController).h)"
