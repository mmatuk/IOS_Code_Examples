...
//  GettingAttentionLab
//
//  Created by csit267-8 on 10/13/15.
...
class ViewController: UIViewController
{
    ...
    @IBAction func doMultiButtonAlert(sender: AnyObject)
    {
        ...
        let cancelAction = UIAlertAction(title: "Never Do It", style: UIAlertActionStyle.Cancel, handler:
            {(alertAction: UIAlertAction!) in
    ...
    {
        let alertController = UIAlertController(title: "Email Addresss", message: "Please enter your email address below:", preferredStyle: UIAlertControllerStyle.Alert)
