...
class ViewController: UIViewController {
    ...
    @IBAction func createStory(sender: AnyObject) {
        ...
        if (thePerson.text != "")
        {
        theStory.text = theStory.text.stringByReplacingOccurrencesOfString("<person>", withString: thePerson.text)
        }
        
        if (theFood.text != "")
        {
        theStory.text = theStory.text.stringByReplacingOccurrencesOfString("<food>", withString: theFood.text)
        }
    }
